                    ...
                    <div style="width: 95%;">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                ...
                                <a href="./TableContent.php?Name_Table=<?php echo $_GET['Name_Table']; ?>&Nom_db=<?php echo $_GET['Nom_db']; ?> " title="add content"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    ...
                                    <tbody id="mytable">
                                        ...
                                        ?>
                                            <td class="py-3 d-flex flex-row align-items-center justify-content-around">
                                                <a href="./DeletContent.php?id=<?php echo $row['id']; ?>&Name_Table=<?php echo $Name_Table; ?>&Nom_db=<?php echo $db; ?>"><i id="1" class='bx bx-trash' style='color:#e02626;font-size:25px;'></i></a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Edit Name table</h5>
